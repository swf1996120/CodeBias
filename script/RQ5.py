            ...
            for cat in os.listdir(scenarior_path):
                ...
                for attr_file in os.listdir(category_path):
                    ...
                    for prompt_type in PROMPT_TYPES:
                        for attack_budge in attack_budges:
                            print(f"Processing: Model={model}, Scenario={scen}, Category={cat}, Attribute={attr}, PromptType={prompt_type}, attack process with {attack_budge}")
                            time.sleep(2)
                            cmd = [
                                "python", PY_SCRIPT,
                                "--model", model,
